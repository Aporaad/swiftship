...
export default function Notifications() {
  ...
  // 1. Listen to system notifications
  useEffect(() => {
              ...
              <div className="space-y-3.5 text-slate-400 text-xs">
                ...
                <div className="space-y-1.5 text-start">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-slate-950 border border-slate-750 rounded-xl py-3.5 pl-11 pr-3.5 text-xs text-white placeholder-slate-700 outline-none focus:ring-1 focus:ring-[#d4af37] focus:border-[#d4af37]"
                    />
                  </div>
                ...
                <div className="space-y-1.5 text-start">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-slate-950 border border-slate-750 rounded-xl p-3.5 text-xs text-white placeholder-slate-700 leading-normal outline-none focus:ring-1 focus:ring-[#d4af37] disabled:opacity-50"
                  />
                </div>
                ...
                <button 
                  ...
                  className="w-full bg-slate-850 hover:bg-slate-750 text-white font-black py-3.5 rounded-2xl text-xs transition active:scale-97 cursor-pointer flex items-center justify-center gap-2 border border-slate-705 disabled:opacity-50"
                >
                  {isTesting ? (
                    <RefreshCw className="w-4 h-4 animate-spin" />
                  ) : (
