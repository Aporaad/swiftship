...
//مهم: يتم تغييرها الى اي حساب تحته ابناء تظهر خاصيه التوسيع له
  ...
  const systemAccounts = useMemo<AccountNode[]>(() => {
    ...
    return [
      ...
      { code: '1240', nameAr: 'أجهزة الحاسوب وتقنية المعلومات', nameEn: 'Computers & Information Technology Assets', type: 'Asset', parentCode: '1200', isSystem: true, balance: 0, currency: 'YER' },
      { code: '1250', nameAr: 'أصول ثابتة ومعدات أخرى', nameEn: 'Other Fixed Assets & Equipment', type: 'Asset', parentCode: '1200', isSystem: true, balance: 0, currency: 'YER' },
      ...
      { code: '2140', nameAr: 'ذمم مصادر الطلبات والموردين', nameEn: 'Order Sources & Suppliers Payables Ledger', type: 'Liability', parentCode: '2100', isSystem: true },
      { code: '2150', nameAr: 'ذمم شركات الشحن والناقلين', nameEn: 'Shipping Companies & Carriers Payables Ledger', type: 'Liability', parentCode: '2100', isSystem: true },
  ...
  const allAccounts = useMemo<AccountNode[]>(() => {
    ...
    customAccounts.forEach(ca => {
      ...
      else if (ca.entityType === 'courier' || ca.entityType === 'employee' || ca.entityType === 'source' || ca.entityType === 'shipping_company') type = 'Liability';
      else if (ca.entityType === 'asset') type = 'Asset';
