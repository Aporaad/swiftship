# SwiftShip — خطة تحويله لتطبيق Desktop على Windows

## وصف المشروع

SwiftShip هو تطبيق React + Express + Supabase لتتبع الشحنات. الهدف هو تحويله إلى برنامج **Desktop ثابت على Windows** يعمل محلياً بدون متصفح منفصل، باستخدام **Electron** الذي يغلّف التطبيق ويجعله يبدو كبرنامج عادي.
